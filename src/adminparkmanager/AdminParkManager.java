...
public class AdminParkManager implements CarParkManager {

	private final Vehicle[] vehicleParkingSlots = new Vehicle[20];//parking space array to store vehicle objects
	...
	private final ArrayList<Integer> vehicleOrderList = new ArrayList<Integer>();//is used to have the index of the vehicles 

	//which are currently parked in the last in First out approach

	private final ArrayList<Vehicle> deletedTempVehicleList = new ArrayList<Vehicle>();//stores the vehicle object which had left the parking space
...
public static void displayMainMenu() {
		...
		CarParkManager carParkObject = new AdminParkManager();
	...
	public void addVehicle() {
		...
		case "car":
			...
			vehicleParkingSlots[checkFreeSpace] = new Car(id, brand, entryTime, color);
